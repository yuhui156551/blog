                ...
                <el-row :class="pdonate?'donate-body':'donate-body donate-body-show'" :gutter="30">
                    <el-col  :span="12"   class="donate-item">
                        <div class="donate-tip">
                            <img :src="detailObj.wechat_image?detailObj.wechat_image: 'static/img/wechat_yh.png'" :onerror="$store.state.errorImg"/>
                            <span>加个微信就好，钱留着自己花</span>
                        </div>
                    </el-col>
                    <el-col :span="12"  class="donate-item">
                        <div class="donate-tip">
                            <img :src="detailObj.alipay_image?detailObj.alipay_image:'static/img/qq.jpg'" :onerror="$store.state.errorImg"/>
                            <span>这个是QQ</span>
                        </div>
                    </el-col>
                </el-row>
