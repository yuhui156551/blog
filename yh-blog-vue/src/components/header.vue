...
<div class="">
	...
	<div class="headImgBox" :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':'url(static/img/wallhaven-yx8yvg.jpg)'}">
		<div class="scene">
		...
		<div class="h-information">
			...
			<h2 class="h-description">
                        ...
                        {{this.$store.state.themeObj.autograph?this.$store.state.themeObj.autograph:"看不清未来，就把握好现在"}}
...
export default {
	data() { //选项 / 数据
		return {
			...
			// path:'',//当前打开页面的路径
			input: '', //input输入内容
			headBg: 'url(static/img/wallhaven-yx8yvg.jpg)', //头部背景图
			headTou: '', //头像
			projectList: '' //项目列表
		}
	},
